...
# agent-kit (docs incl. LEGACY-HUNTER, workflows, clients/paransky97; exclude personal scaffold)
...
REQUIRED=(
  ...
  "$OUT/agent-kit/clients/paransky97/.workflow.md"
...
if [[ "$(head -1 "$OUT/VERSION")" != "v2.2.0" ]]; then
  echo "FAIL: VERSION must be v2.2.0" >&2
  exit 1
fi
