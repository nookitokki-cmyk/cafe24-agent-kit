...
> **실증 몰:** [`getting-started/예시-데모몰.md`](../getting-started/예시-데모몰.md) — ecudemo400786 (`editor_type=HTML`, EZ skin16 FTP 오버레이 on `/sde_design/base` + `_ref393674`)
...
상세 비판·근거: 본 문서 말미 **「판정 근거」** · [`docs/common-pitfalls.md`](../docs/common-pitfalls.md)
...
**파트너 몰 경로 규칙:** 일반몰 `/skin16` 루트 vs 파트너 `/sde_design/base` — [`docs/_evidence/partner-live-ecudemo400786-2026-06-19.txt`](../docs/_evidence/partner-live-ecudemo400786-2026-06-19.txt)
...
**참조 구현 (HTML+EZ FTP):** ecudemo400786 — 관리자 HTML 타입 유지, EZ skin16을 `/sde_design/base/`에 FTP 오버레이, `_ref393674/`만 편집. Easy 타입 미등록. → [`getting-started/예시-데모몰.md`](../getting-started/예시-데모몰.md)

상세: [`docs/common-pitfalls.md`](../docs/common-pitfalls.md) §F35 · [Easy 초기화 오류](https://support.cafe24.com/hc/ko/articles/9131043889945)

**EZ 선별 이식·걷어내기:** brain §6 F36 · [`WORK-GUIDE.md`](../docs/WORK-GUIDE.md) §15 (`strip_ez.py`) · STEP 2 strip_ez in [`CAFE24-SMARTDESIGN-AGENT.md`](../docs/CAFE24-SMARTDESIGN-AGENT.md)
...
- 규칙: [`rules/ez-contents-width.md`](../rules/ez-contents-width.md)
- 스니펫: [`docs/snippets/ez-contents-override.css`](../docs/snippets/ez-contents-override.css)
- F코드: **F8** wrap overflow, **#contents** → `docs/F-상황-인덱스.md` 검색
...
- 한 파일: `sub-paginate.css` @ body 끝 — [`docs/snippets/ec-paginate-override.css`](../docs/snippets/ec-paginate-override.css)
- 함정: [`docs/common-pitfalls.md`](../docs/common-pitfalls.md) §전역 페이징

### 3-D. Mobile

- [`rules/responsive-mobile.md`](../rules/responsive-mobile.md)
...
#contents override는 rules/ez-contents-width.md 첫 블록으로.
```
...
**반대 근거 (키트 postmortem)**  
- `#contents` 92%, dual CSS, paginate 로드 순서, MO 스킨 분리, module 마크업 불일치 — [`docs/common-pitfalls.md`](../docs/common-pitfalls.md)
