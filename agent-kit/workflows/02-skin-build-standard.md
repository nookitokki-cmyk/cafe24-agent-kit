...
3. 두뇌 문서 F1~F20 매칭하여 미리 발견된 함정 표시
...
완료 기준:
  ...
  - **EZ 92% trap:** override 레이어 **첫 파일·첫 블록**에 `#container #contents { width:100% !important; margin:0 !important; }` (`rules/ez-contents-width.md`, `docs/snippets/ez-contents-override.css`)
...
산출물:
  ...
  - 각 섹션의 nk- 접두사 클래스
완료 기준:
  - 모든 섹션이 **동일 base 템플릿** + `@media` 로 PC·MO 대응 (별도 `/sde_design/mobile/` HTML 금지 — `rules/responsive-mobile.md`)
...
- 어느 섹션의 어떤 함정인지 두뇌 문서 F1~F20 매핑
