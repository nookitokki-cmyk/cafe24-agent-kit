...
> **읽는 법:** 에이전트는 문제 생기면 **여기서 번호 찾고** → `docs/CAFE24-SMARTDESIGN-AGENT.md` §6에서 상세 읽기.  
...
> **F27~F34** 상세: [`docs/common-pitfalls.md`](../docs/common-pitfalls.md) · 학생용 허브: [`docs/F-상황-인덱스.md`](../docs/F-상황-인덱스.md)
...
- 상세 문법 전체: `docs/CAFE24-SMARTDESIGN-AGENT.md` §4~§6
