...
Firecrawl CLI 미인증 시: `developers.cafe24.com` · `brain/_evidence/*.html` 스크랩 우선.
...
| editor_type (API) | **H**: 스마트디자인(HTML) · **E**: 스마트디자인Easy | `brain/_evidence/phase-1e-api-quotes.txt` |
