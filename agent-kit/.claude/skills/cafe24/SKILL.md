...
> **출처**: 이 스킬은 실제 프로젝트 코드 분석(slowagings 클라이언트) + 공식 문서(sdsupport.cafe24.com) 기반.
...
> **출처 등급:** ✅ Admin API `editor_type` · ⚠️ 아래 표 중 SFTP/경로/호환 — [`OFFICIAL-AUDIT.md`](../../../docs/OFFICIAL-AUDIT.md) · [`VERIFICATION-EVIDENCE.md`](../../../docs/VERIFICATION-EVIDENCE.md)

| 구분 | 스마트디자인 (HTML, **H**) | 스마트디자인Easy (**E**) |
|-----|------------------------|-----------------|
| API 구분 | `editor_type` **H** ✅ | `editor_type` **E** ✅ |
| 편집 방식 | HTML/CSS/JS + SFTP ⚠️ | 비주얼 블록 + 관리자 편집 ⚠️ |
| SFTP (paransky97 실측 2026-06-19) | `/{skin_code}` 접근 OK ⚠️ | **동일** — E 스킨도 `/skin14`, `/base` list OK ⚠️. 「Easy=SFTP 불가」는 **과장** |
...
### 실제 스킨 3개 비교 (slowagings 프로젝트 기준)
...
<!-- ✅ 올바름 — 하드코딩 -->
<span class="nk-drawer__brand">SLOWAGINGS</span>
```
...
> 출처: 본문은 slowagings 실프로젝트 분석 기반. references/ 사전 항목은 kimyoungwopo/cafe24-smart-design(MIT) + 공식문서에서 보강.
