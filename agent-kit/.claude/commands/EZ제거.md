...
전략: [`docs/EZ-STRATEGY.md`](../docs/EZ-STRATEGY.md) — 기본 **strip** (paransky97). ecudemo400786 Phase C 스킵은 **예외**.
...
- 레퍼런스: `clients/paransky97/.workflow.md` · `docs/PARANSKY97-EZ-INVESTIGATION.md`
