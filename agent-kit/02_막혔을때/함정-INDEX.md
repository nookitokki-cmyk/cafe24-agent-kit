...
| **F35** | Easy 타입 + FTP/HTML 편집 충돌 — GUI 메타·소스 불일치 | 🟡 |
| **F36** | EZ 이식·통째 덮기 / ez-settings 무분별 삭제 — 선별 이식 + strip_ez | 🟡 |

> **F27~F36** 상세: [`02_막혔을때/common-pitfalls.md`](common-pitfalls.md) · 학생용 허브: [`02_막혔을때/F-상황-인덱스.md`](F-상황-인덱스.md)

## 초보자용 5대 함정 (00_시작하기 04 ↔ 공식)
