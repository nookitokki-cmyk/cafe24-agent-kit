...
**초보자용 상세:** [`00_시작하기/05b-MCP-등록.md`](../00_시작하기/05b-MCP-등록.md) · **`/키트시작`**
...
**상세 OAuth/SFTP:** `agent-kit/connect/MCP-OAUTH-GUIDE.md` 또는 `/접속세팅` — OAuth 앱·`cafe24_config_{mall}.py`·토큰 발급. SFTP: `sftp_{mall}.json` 작성 (일반몰 vs 파트너 `/sde_design/` 경로 — `MCP-OAUTH-GUIDE.md` 참조).



**EZ 전략:** 기본 **strip** ([`EZ-STRATEGY.md`](../brain/docs/EZ-STRATEGY.md)). ecudemo400786만 Phase C **스킵** 파일럿 예외.
...
- [`LEGACY-HUNTER.md`](../brain/docs/LEGACY-HUNTER.md) — strip 전후 스킨 감사
