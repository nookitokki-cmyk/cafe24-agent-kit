...
> **실행 절차:** [`WORK-GUIDE.md` §15](WORK-GUIDE.md) · [`08-ez-three-step-pingpong.md`](../../01_작업하기/workflows/08-ez-three-step-pingpong.md) Phase C
...
- 키트 canonical은 **관리자 HTML 타입 skin 복사 + FTP overlay** ([`07` Phase 0-D](../../01_작업하기/workflows/07-ez-on-legacy-setup.md)) — Easy 타입 등록 없음 (**F35** 회피).
...
- **허용:** HTML 타입 skin에 EZ **테마 코드**만 FTP로 올린 다음, 코드 레벨에서 strip ([`07` Phase 0-D](../../01_작업하기/workflows/07-ez-on-legacy-setup.md)).
...
- **검증:** [`06-verify-loop.md`](../../01_작업하기/workflows/06-verify-loop.md) — score **100 only**.
...
- 상세: `clients/ecudemo400786/.workflow.md` · [`00_시작하기/예시-데모몰.md`](../../00_시작하기/예시-데모몰.md)
...
| [`08-ez-three-step-pingpong.md`](../../01_작업하기/workflows/08-ez-three-step-pingpong.md) | Phase A/B/C 실행·핑퐁 |
| [`07-ez-on-legacy-setup.md`](../../01_작업하기/workflows/07-ez-on-legacy-setup.md) | Phase 0-D F35 · 전체 배경 |
| [`common-pitfalls.md` §F35·F36](../../02_막혔을때/common-pitfalls.md) | Easy 타입 충돌 · strip 함정 |
