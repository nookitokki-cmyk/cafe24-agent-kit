...
> **선행 읽기:** [`EZ-STRATEGY.md`](EZ-STRATEGY.md) · [`F-상황-인덱스.md`](../../02_막혔을때/F-상황-인덱스.md) · [`common-pitfalls.md`](../../02_막혔을때/common-pitfalls.md) · [`01_작업하기/workflows/06-verify-loop.md`](../../01_작업하기/workflows/06-verify-loop.md)
...
| **MOBILE_WEB** | `[알면: true / false / 미확인]` — `true`이면 MO 검증 중단 ([F34](../../02_막혔을때/F-상황-인덱스.md)) |
...
> **F26** · [`02_막혔을때/함정-INDEX.md`](../../02_막혔을때/함정-INDEX.md) — `@layout` 미참조 layout = 고아 **의심**. 팝업·주문 edge는 로컬 grep만으로 놓치기 쉽다.
...
`전역` · `main` · `plp-full` · `pdp-full` · `narrow` · `popup` · `order` · `board` · `member` — [`common-pitfalls.md`](../../02_막혔을때/common-pitfalls.md) 타입표와 동일 용어 사용.

---

## 7. 수정 전 검증 게이트 (Verification gate)

Legacy Hunter가 **수정·삭제·FTP put**을 제안하더라도, 실행 전 아래를 통과해야 한다 ([`06-verify-loop.md`](../../01_작업하기/workflows/06-verify-loop.md)).
...
agent-kit/brain/docs/LEGACY-HUNTER.md 절차를 따를 것:
