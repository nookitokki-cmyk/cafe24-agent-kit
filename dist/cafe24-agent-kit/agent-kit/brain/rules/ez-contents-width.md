...
| `brain/docs/snippets/ez-contents-override.css` 복사 후 타입 class 맞춤 | 튜토리얼의 `body #contents { margin:0 }` 그대로 복사 |
...
- 스니펫: [`brain/docs/snippets/ez-contents-override.css`](../docs/snippets/ez-contents-override.css)
- 함정: [`02_막혔을때/common-pitfalls.md`](../../02_막혔을때/common-pitfalls.md) §EZ #contents 92% trap
- verify: [`01_작업하기/workflows/06-verify-loop.md`](../../01_작업하기/workflows/06-verify-loop.md) Phase 0 pre-flight
- skin-build: [`01_작업하기/workflows/02-skin-build-standard.md`](../../01_작업하기/workflows/02-skin-build-standard.md) ③ Setup
