---
name: 토대정리
description: 카페24 디자인 토대 세팅(워크플로우 C단계) — base 함정 전수 스캔 + nk-cafe24-reset.css 적용 + 디자인 토큰 세팅. 시안/레퍼런스 구현 직전, 섹션 제작 전에 1회. "토대 정리", "밑칠 제거", "base 스캔", "reset 적용", "토큰 세팅", "디자인 토대" 같은 요청 시 사용.
---
